...
No sākuma uzinstelētas un pievienotas paketes ar kuru palīdzību veicām nepieciešamās analīzes. Pievienošanu darba sesijai veicām ar funkciju library().
...
Datu normalitātes pārbaudei izmantojām Kvantiļu diagrammmas un Vertıbamplitudu diagrammu.

## Paraugkopu salīdzināšana

Izmantotas neparametriskās metodes kā  Wilkoksona tests.

## Korelācijas analīze 

Korelacijas analızes veikšanai izmantotas funkcija cor.test() aprēķinot pēc Spīrmena metodes (method ="spearman"). Rezultātu novērtēšanai tika izmantota korelāciju matrica.

## Lineārā regresija

Izmantota daudzfaktoru regresijas analzes funkcija lm(). Modeļu salīdzinājums veikts, izmantojot AICc kritēriju.Modeļa rezultātu tabula tiek iegūta, izmantojot sjPlot::tab_model() funkciju

## Jaukta efekta modeļi 

Izmantota lineārā jaukto efektu modeļa izveide (lmer funkcija). Modeļa rezultātu tabula tiek iegūta, izmantojot sjPlot::tab_model() funkciju.

## Datu vizualizācija

Datu vizuālizācijai izmantotas paketes kā qqplotr(), cowplot(), tidyverse().
...
Šis liecina, ka cukurniedru vecums lielā mērā neietekmē šķidru daudzumu.
...
Šis liecina, ka palielinoties cukura daudzumam, nedaudz samazinās šķiedru daudzums, bet saiastība ir vāja.
