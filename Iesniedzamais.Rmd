...
AICc_model9 <- AICc(model9)
AICc_model11 <- AICc(model11)
AICc_model12 <- AICc(model12)
AICc_model13 <- AICc(model13)

# Salīdziniet AICc vērtības
AICc_values <- data.frame(Model = c("Model1", "Model4", "Model6", "Model7", "Model9", "Model11", "Model12", "Model13"),
  AICc = c(AICc_model1, AICc_model4, AICc_model6, AICc_model7, AICc_model9, AICc_model11, AICc_model12, AICc_model13))
print(AICc_values)

```
Pēc AIC vertības  modelis (1. modelis) ir labāks, jo šı modeļa AICc vertıba ir  mazaka nekā 2. modeļa.
